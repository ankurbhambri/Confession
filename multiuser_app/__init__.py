...
colors = ['#ADFF2F', '#FFB6C1', '#556B2F', '#FF8C00', '#9932CC', '#FF4500', '#BA55D3', '#2F4F4F', '#00008B', '#DB7093', '#008B8B', '#DC143C',
          '#DDA0DD', '#4169E1', '#7B68EE', '#AFEEEE', '#800080', '#6B8E23', '#FF69B4', '#000080', '#228B22', '#5F9EA0', '#EE82EE',
          ...
          '#FFFF00', '#006400', '#DEB887', '#FF7F50', '#7CFC00', '#FA8072', '#FFDAB9', '#D2691E', '#FF1493', '#98FB98', '#800000', '#87CEFA',
          ]
...
s = s.replace('~', '{').replace('`', '}')
print(BASE_DIR + '/static/css/profile/color.css')
